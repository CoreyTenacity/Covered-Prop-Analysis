...
create index if not exists saved_picks_saved_at_idx on public.saved_picks (saved_at desc);
create index if not exists saved_picks_result_idx on public.saved_picks (result);
create index if not exists saved_picks_grading_status_idx on public.saved_picks (grading_status);
